...
# ╔═╡ d4e61d82-2670-4732-b23e-4d1cec9fcbca
main = function solve_main()
	...
	return Dict('x' => x, 'θ' => θ , 'o' => obj)
end

# ╔═╡ 47b98f24-dd1b-4c47-8e86-481177f68d02
main()['x']

# ╔═╡ 120e5167-f89b-4a16-9510-2b61219ad010
x = solve_main()['x']

# ╔═╡ 4ce7f045-4ec9-4c43-b6c4-b446aeb6cc7e
θ = solve_main()[2]
...
# ╔═╡ f0319aeb-33d6-4913-8e24-dce014869518
sub = function solve_sub(x)
	...
	λ = dual.(all_cons)
	return Dict('y' => y, 'o' => obj, 'λ' => λ)
end

# ╔═╡ 48741e0f-0da6-421a-80d9-91aaceeed13b
sub(x)['o']

# ╔═╡ 6acc70ec-e3ed-4ce3-809b-a4c6e63d39e0
solve_sub(x)

# ╔═╡ 21fccf0b-4181-4b47-a06c-1f07e55879a9
y = solve_sub(x)[1]

# ╔═╡ c2b633e3-96c1-46b9-928e-8b30dc9f2938
obj = solve_sub(x)[2]

# ╔═╡ c94a5d85-5cd6-4d8f-b7e1-93b8d0e86eea
λ = solve_sub(x)[3]
...
# ╔═╡ 25cfccdc-9ef6-447b-aea9-23cf65e40d9a


# ╔═╡ 8ef38c98-63ce-43a0-8ee1-dcb396c13975
MAXIMUM_ITERATIONS = 100

# ╔═╡ 36277565-0c9b-4bdf-b99b-b6e297575dbf
ABSOLUTE_OPTIMALITY_GAP = 1e-6

# ╔═╡ aab31779-b961-4a94-8844-e5538e77f136
for k in 1:MAXIMUM_ITERATIONS
	main()
	lower_bound = main()['o']
	xᵏ = main()['x']
	upper_bound = c1' * main()['x'] + sub(xᵏ)['o']
...
# ╠═178b79d7-0378-4620-8615-9c517b6f80f7
# ╠═3039bb41-4657-45fc-bf3a-a75da3e74dbc
# ╠═4e1483a7-27d4-47fe-aa13-67dbf11c1dd1
# ╟─e7f98549-da6e-4d5e-acac-dfe953e38e31
# ╟─0721d470-17e8-4751-b419-0c9c28b28864
# ╟─de8fd381-e12a-4c8e-8e24-4f7728d244ca
# ╟─dc2a5924-f3da-4416-9c91-b2eca46fe593
